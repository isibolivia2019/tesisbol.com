...
<section class="featured BGprime page-block-small">
	<div class="container wow fadeInDown" data-wow-duration="0.50s" data-wow-delay="0.50s">
	<div class="col-md-12">
	<h1><small></small>¿Cómo trabajamos?</h1>
	</div>
	</div>
	</section>
...
<div class="container wow fadeInDown" data-wow-duration="0.50s" data-wow-delay="0.50s">
<div class="col-md-12">
<h1><small>Ofrecemos servicio</small>en todas las areas</h1>
</div>
</div>
</section>


<section class="recent-project smallSlider page-block-large BGlight">
...
<div class="section-heading">
<h2><i class="fa fa-star square BGsec"></i>¿Por que elegirnos? <small></small></h2>
<div class="clear"></div>
</div>
<ul class="list-main">
<li>
<h5>Contamos con equipo altamente profesional.</h5>
En tesisbol te asesoramos con nuestro equipo de trabajo altamente calificado y dispuesto a realizar tu trabajo contigo.
</li>
<li>
<h5>Estamos comprometidos contigo</h5>
Te ofrecemos nuestros servicios profesionales en la realización de Proyectos de Grado, Tesis, Tesinas, Anteproyectos, Monografías, Ensayos, y demás investigaciones afines.
</li>
<li>
<h5>Entregamos los mejores resultados.</h5>
El estudiante de medio tiempo podrá egresar exitosamente de su institución sin dejar de realizar las actividades que tanto desea.
</li>
</ul>
</div>
</div>
...
<div class="col-md-12">
<div class="section-heading">
<h2><i class="fa fa-quote-left square BGsec"></i>Testimonials <small>What people say about us!</small></h2>
<a class="btn btn-primary" href="testimonials.html" title="View All Testimonials">View All Testimonials <i class="fa fa-chevron-circle-right"></i></a>
<div class="clear"></div>
</div>
<ul class="bxslider">
<li class=" item">
<div class="col-md-6 col-sm-6 col-xs-6">
<div class="pic"><img class="img-responsive" src="images/quote/01.jpg" alt="Jenny Doe" width="100" height="100" /></div>
<div class="info">
<h4>Jenny Doe<span>CEO</span></h4>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer gravida velit quis dolor tristique accumsan. Pellentesque elit tortor, adipiscing vel velit inermentum nulla. Donec in urna semulla facilisi.</p>
</div>
</div>
<div class="col-md-6 col-sm-6 col-xs-6">
<div class="pic"><img class="img-responsive" src="images/quote/02.jpg" alt="John Doe" width="100" height="100" /></div>
<div class="info">
<h4>John Doe<span>Business Executive</span></h4>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean id ipsum facilisis, congue ex at, tempus lacus. Sed rhoncus tincidunt felis, eu tempus metus pretium nec. Interdum et malesuada fames ac ante ipsum primis in faucibus. </p>
</div>
</div>
</li>
<li class=" item">
<div class="col-md-6 col-sm-6 col-xs-6">
<div class="pic"><img class="img-responsive" src="images/quote/03.jpg" alt="Jarvis Doe" width="100" height="100" /></div>
<div class="info">
<h4>Jarvis Doe<span>Design Expert</span></h4>
<p>Sed velit nulla, hendrerit nec euismod eu, interdum eget ipsum. Sed turpis lacus, egestas in nulla vel, rutrum auctor felis. Integer ac congue arcu. Nullam maximus elit purus. Pellentesque habitant morbi tristique senectus</p>
</div>
</div>
<div class="col-md-6 col-sm-6 col-xs-6">
<div class="pic"><img class="img-responsive" src="images/quote/04.jpg" alt="Cyra Doe" width="100" height="100" /></div>
<div class="info">
...
<li class=" item">
<div class="col-md-6 col-sm-6 col-xs-6">
<div class="pic"><img class="img-responsive" src="images/quote/05.jpg" alt="Shawn Doe" width="100" height="100" /></div>
<div class="info">
<h4>Shawn Doe<span>Business Executive</span></h4>
<p> Keset netus et malesuada fames ac turpis egestas. Mauris justo dolor, egestas sed feugiat vitae, iaculis vulputate lorem. Vivamus in ex odio. Sed eget fringilla dui, ut auctor odio. Sed in diam sit amet dolor bibendum suscipit.</p>
</div>
</div>
<div class="col-md-6 col-sm-6 col-xs-6">
<div class="pic"><img class="img-responsive" src="images/quote/06.jpg" alt="Sandra Doe" width="100" height="100" /></div>
<div class="info">
<h4>Sandra Doe<span>Business Executive</span></h4>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer gravida ve Aliquam accumsan commodo nunc accumsan sollicitudin. Cras molestie est quis miit inermentum nulla. Donec in urna semulla facilisi.</p>
</div>
</div>
</li>
</ul>
